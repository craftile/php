 ...
 * @method static void registerDiscoveredSchemas(?callable $filter = null)
 * @method static void refreshDiscoveredSchemas(?callable $filter = null)
 * @method static void filterDiscoveredSchemasUsing(?callable $filter)
